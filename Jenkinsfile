...
stage 'Build'
  ...
  sh '/Library/Frameworks/Mono.framework/Versions/Current/bin/mono $MONO_OPTIONS /Library/Frameworks/Mono.framework/Versions/Current/lib/mono/msbuild/Current/bin/msbuild XamarinNavigationBlank.sln'
